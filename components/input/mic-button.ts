...
const micOff = require("../../assets/svg/mic_off-24px.svg");
const micOn = require("../../assets/svg/mic-24px.svg");
	...
	render() {
		return html`
			<tone-button 
				...
				${unsafeHTML(!this.open ? micOn : micOff)}
			</tone-button>
		`;
	}
}
customElements.define("tone-mic-button", ToneMicButton);
